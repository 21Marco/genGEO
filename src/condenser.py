...
class Condenser:
    ...
    def computeWaterCondenser(self, T_out_desh, mdot_ratio, q_condenser_orc, q_desuperheater_orc):
        p_amb = 10e4
        ...
        if self.params.dT_cooling == 0:
            ...
            self.params.dT_pinch_cond = self.params.T_condense_C - T_cooling_water_mid

            if T_cooling_water_mid > self.params.T_condense_C:
    ...
    def computeAirCondenser(self, T_out_desh, mdot_ratio, q_condenser_orc, q_desuperheater_orc):
        p_amb = 10e4
        ...
        if self.params.dT_cooling == 0:
            ...
            self.params.dT_pinch_cond = self.params.T_condense_C - T_cooling_air_mid

            if T_cooling_air_mid > self.params.T_condense_C:
